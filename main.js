...
d3.csv("nobel_laureates.csv").then(data => {
    ...
    const maxCount = d3.max(yearCounts.flat(), yearValues => yearValues);
    ...
    // - Add stroke-width and optional hover effects.
        .style("stroke", d => colorScale(d[1]) || "#cccccc")
        .style("fill", "none")
    ...
    svgLine.append("text")
        ...
        .style("font-family", "New Century Schoolbook")
    ...
    legend.append("rect")
        ...
        .attr("width", 10)
        .attr("height", 10)
        .style("fill", d => colorScale(d[1])); // Use category name for color
